...
def getbanner(sg1):
    return sg.Frame('', sg1,  pad=(0,0), background_color='#1B2838',  expand_x=True, border_width=0, grab=True)
def getTop(sg1):
...
def getdropDown(na,ls,defa):
    return sg.Combo(ls,key=na,size=(getLongestLen(ls)[0],len(ls)),default_value=defa)
