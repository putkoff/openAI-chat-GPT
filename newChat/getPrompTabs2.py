...
def getPrompts(category,specialization):
    ...
    tabLay[0] = guiFun.getTab({"title":str(specialization)+"_fileUpload","layout":[tabLay[0]],"key":str(specialization)+"_fileUpload_tab","visible":True,"button_color":None,"orientation":'h'})
